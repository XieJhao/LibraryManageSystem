...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UserForm_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UserForm_t qt_meta_stringdata_UserForm = {
    {
QT_MOC_LITERAL(0, 8) // "UserForm"
...
const QMetaObject UserForm::staticMetaObject = { {
    ...
    qt_meta_stringdata_UserForm.offsetsAndSize,
    qt_meta_data_UserForm,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UserForm_t
, QtPrivate::TypeAndForceComplete<UserForm, std::true_type>
